...
function init_common_kingbird_conf {
    ...
    iniset $conf_file DEFAULT kingbird_db_connection `database_connection_url kingbird`
...
function configure_kingbird_api {
    ...
    if is_service_enabled kb-api ; then
        ...
        init_common_kingbird_conf $KINGBIRD_API_CONF
...
function configure_kingbird_engine {
    ...
    if is_service_enabled kb-engine ; then
        ...
        init_common_kingbird_conf $KINGBIRD_ENGINE_CONF
    fi
}
