...
class DBAPIResourceSyncTest(base.KingbirdTestCase):
    ...
    def test_create_sync_job(self):
        ...
        created_job = db_api.sync_job_list(self.ctx, "list")
    ...
    def test_sync_job_update(self):
        ...
        updated_job = db_api.sync_job_list(self.ctx, 'list')
    ...
    def test_sync_job_status(self):
        ...
        self.assertEqual(query, 'IN_PROGRESS')

    def test_sync_all_job_list(self):
        self.sync_job_create(self.ctx, job_id=UUID1)
        self.sync_job_create(self.ctx, job_id=UUID2)
        query = db_api.sync_all_job_list(self.ctx, 'all')
    ...
    def test_delete_sync_job(self):
        ...
        updated_job = db_api.sync_job_list(self.ctx, action='list')
