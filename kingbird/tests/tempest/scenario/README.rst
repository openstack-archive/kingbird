...
are configured in kingbird/tests/tempest/scenario/config.py.
...
.. sourcecode:: console
    ...
    $ tox -e all-plugin -- tempest.scenario.quota_management.client_tests
..
...
.. sourcecode:: console
    ...
    $ tox -e all-plugin -- tempest.scenario.quota_management.client_tests.test_kingbird_api.KingbirdTestJSON.test_get_quota_usage_for_project
..
