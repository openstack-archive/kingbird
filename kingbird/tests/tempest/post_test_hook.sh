...
testr list-tests | grep quota_management

testr run scenario.quota_management.client_tests.test_quota_management_api.KingbirdQMTestJSON.test_kingbird_get_own_quota
