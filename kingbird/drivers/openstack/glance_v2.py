...
class GlanceClient(object):
    ...
    def create_image(self, image, force, kernel_image=None,
        ...
        if force:
            ...
            kwargs.pop('id')
        if hasattr(image, 'architecture'):
            kwargs["architecture"] = image.architecture
        if hasattr(image, 'os_version'):
            kwargs["os_version"] = image.os_version
        if hasattr(image, 'os_distro'):
            kwargs["os_distro"] = image.os_distro
        if kernel_image:
