...
class OpenStackDriver(object):
    ...
    def get_enabled_projects(self):
        try:
            ...
            LOG.exception(_LE('Exception while getting project details'))
    ...
    def get_resource_usages(self, project_id):
        try:
            ...
            LOG.exception(_LE('Exception during get resource usage'))
    ...
    def write_quota_limits(self, project_id, limits_to_write):
        try:
            ...
            LOG.exception(_LE('Exception during write quota limits'))
    ...
    def delete_quota_limits(self, project_id):
        try:
            ...
            LOG.exception(_LE('Exception during delete quota limits'))
