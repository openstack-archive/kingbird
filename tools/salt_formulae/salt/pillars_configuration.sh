...
cat > kingbird_service.sls << EOF
sample_kb_conf_file: '/srv/salt/kingbird_template.j2'
migration_script: 'kingbird/kingbird/cmd/manage.py --config-file=/etc/kingbird/kingbird.conf'
api_script: 'kingbird/kingbird/cmd/api.py --config-file=/etc/kingbird/kingbird.conf'
engine_script: 'kingbird/kingbird/cmd/engine.py --config-file=/etc/kingbird/kingbird.conf'
service_name: 'kingbird'
bind_host : '0.0.0.0'
bind_port : '8118'
cache_auth_uri : $OS_AUTH_URL
cache_admin_username : $OS_USERNAME
cache_admin_password : $OS_PASSWORD
cache_admin_tenant_id : `python /srv/salt/admin_tenant_details.py`
cache_admin_user_domain_name : 'default'
cache_admin_project_domain_name : 'default'

#auth_token_keystone_memcached__servers: ''
...
auth_token_auth_url : $OS_AUTH_URL
